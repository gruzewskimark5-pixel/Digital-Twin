          ...
          <div className="glass-panel rounded-xl p-4 flex flex-col gap-4 flex-1">
            ...
            <div className="mt-auto">
              ...
              <div className="bg-black/60 rounded-lg p-3 border border-gray-800 h-48 overflow-hidden font-mono text-[10px] leading-relaxed flex flex-col gap-1">
                {/* ⚡ Bolt Optimization: Use stable unique key for prepended lists
                    Since telemetry logs are prepended every second, using an index key causes
                    React to unmount/remount all DOM nodes. Using the unique log string
                    prevents massive DOM mutation overhead on every simulation tick. */}
