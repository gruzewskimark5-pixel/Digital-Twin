...
// App.tsx has a 1-second interval ticking that triggers re-renders.
// Wrapping these heavy layer components in memo() ensures they are not unnecessarily re-rendered
// on every single tick, drastically reducing DOM mutation and React reconciliation overhead.
