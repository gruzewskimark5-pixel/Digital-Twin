...
// ⚡ Bolt Optimization: Replace deeply nested ternary chain with an O(1) dictionary object lookup
// ⚡ Bolt Optimization: Memoize HeaderTitle to prevent evaluating title lookups on every 1s tick
  ...
  useEffect(() => {
    savedCallback.current = () => {
      ...
      setJobs(prevJobs => {
        ...
        // ⚡ Bolt Optimization: Preserve structural sharing by returning the exact previous array reference
        // if no internal elements actually changed during this tick. This prevents large downstream re-renders.
