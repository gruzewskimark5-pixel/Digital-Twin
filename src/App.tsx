...
// ⚡ Bolt Optimization: Wrap React.lazy() imports with React.memo()
// App.tsx re-renders every 1 second due to the simulation tick.
// Wrapping these lazy-loaded layer components with memo() prevents them from
// undergoing unnecessary reconciliation and re-rendering on every tick,
// saving significant CPU cycles since their props do not change.
