        ...
        <div className="lg:col-span-3 flex flex-col gap-6">
          <div className="glass-panel rounded-xl p-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              {/* ⚡ Bolt Optimization: Using memoized NodeSelector component to prevent executing cn() for each node on every 1s simulation tick */}
              <NodeSelector nodes={MOCK_NODES} activeNode={activeNode} onNodeSelect={setActiveNode} />
            </div>
          </div>
