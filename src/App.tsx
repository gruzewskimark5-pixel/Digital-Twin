          ...
          <div className="glass-panel rounded-xl p-4 flex flex-col gap-4 flex-1">
            ...
            <div className="mt-auto">
              ...
              <div className="bg-black/60 rounded-lg p-3 border border-gray-800 h-48 overflow-hidden font-mono text-[10px] leading-relaxed flex flex-col gap-1">
                {/* ⚡ Bolt Optimization: Use stable key (log string) instead of array index.
                    Since items are prepended, using index 'i' causes React to mutate the text content
                    of EVERY node in the list on every 1-second tick. A stable key prevents this O(N) re-render. */}
