...
// ⚡ Bolt Optimization: Wrap lazy components in React.memo to prevent unnecessary re-renders
// during the 1-second simulation tick, drastically reducing reconciliation overhead.
