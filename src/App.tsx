...
// Wrapped lazy imports with React.memo() to prevent unnecessary re-renders of hidden layer components
// when the main App.tsx interval ticks every 1000ms. This significantly reduces React reconciliation overhead.
